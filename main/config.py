...
prompt = (
            ...
            # "Plan Start date for the next task is after previous task's Plan End date for everyone."
            # "Ensure the next task's Plan Start date is after previous task's Plan End date for the same person."
            ...
            "Please avoid adding extra tasks."
            # "Please avoid adding redundant tasks."
